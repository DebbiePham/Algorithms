...
//         let nonConsec = { i: 0, n: 0 };
//         if (sortedNumbers[i] != sortedNumbers[i + 1] - 1) {
//         nonConsec.i = i + 1;
//         nonConsec.n = sortedNumbers[i + 1];
//         output.push(nonConsec);
//         }
//     }
...
function allNonConsecutive(sortedNumbers) {
    ...
    for (let i = 1; i < len; i++) {
        if (sortedNumbers[i] !== sortedNumbers[i - 1] + 1) {
            result.push({ i, n: sortedNumbers[i] });
        }
    }
...
console.log(allNonConsecutive(numbers1), 'should equal', expected1);
console.log(allNonConsecutive(numbers2), 'should equal', expected2);
console.log(allNonConsecutive(numbers3), 'should equal', expected3);
console.log('*****************************************************************************');
    ...
    for (let i = 0; i < len; i++) {
        ...
        for (let j = i; j < len; j++) {
            ...
            if (currentSum === targetSum) {
                result.push(numbers.slice(i, j + 1));
            }
        }
    }
...
console.log(findConsecutiveSums(numbers1_1, sum1), 'should equal', expected1_1);
console.log(findConsecutiveSums(numbers2_1, sum2), 'should equal', expected2_1);
console.log(findConsecutiveSums(numbers3_1, sum3), 'should equal', expected3_1);
console.log(findConsecutiveSums(numbers4_1, sum4), 'should equal', expected4_1);
console.log(findConsecutiveSums(numbers5_1, sum5), 'should equal', expected5_1);
